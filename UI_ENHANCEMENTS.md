...
**Version**: 2.8.0  
**Updated**: 2026-09-23  
**Features**: Interactive Clickable UI + Sorting on All Pages + Search + Real-Time Cyber Attack Map with Detail Overlay + Configurable Refresh + Security Breaches Focus + Hong Kong Region + AI/ML Insights
